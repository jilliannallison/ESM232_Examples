...
colnames(parm_quant)=pnames # column names 
...
# to make it easy to change i'm setting standard deviation / range variation to a variable --- makes it easy to vary later if we wanna change it 
pvar = 10

# giving the name of the parmquant matrix generated from LH sampling 
