...
tmp = map_df(site2,`[`, c("annual"))  # Extracting from a list , note the bracket 
...
Submit as a group: an Rmarkdown document, your R files for almond yield and profit model, and Graph on Canvas- 
