...
# run the solver
Ptime = ode(y=initialrabbits, times=years, func=dexppop,parms=c(0.03))
head(Ptime)
colnames(Ptime)=c("year","P")

mytest = ode(y = 30, times = 1:15, func = dexppop, parms = c(0.01))
...
alternativeparms = list(r=0.04, carry_capacity=10000)
...
result = diff1(initialC=1000, nx=2, dx=5, nt=8, dt=1, D=1, area=10)
